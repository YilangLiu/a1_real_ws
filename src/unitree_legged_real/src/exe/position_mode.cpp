...
int mainHelper(int argc, char *argv[], TLCM &roslcm)
{
    ...
    while (ros::ok()){
        ...
        if(initiated_flag == true){
            ...
            // printf("%d\n", motiontime);
            //printf("%f %f %f\n", RecvLowROS.motorState[FR_0].q, RecvLowROS.motorState[FR_0].dq, RecvLowROS.motorState[FR_0].tauEst);
            // std::cout<<"Motor Torque: "<< RecvLowROS.motorState[FR_0].tauEst<<std::endl;
            // std::cout<<"Motor Position: : "<< RecvLowROS.motorState[FR_0].q <<"q_raw: "<<RecvLowROS.motorState[FR_0].q_raw<<std::endl;
            // printf("%f %f \n",  RecvLowROS.motorState[FR_0].mode, RecvLowROS.motorState[FR_1].mode);
            // std::cout<<"Motor Position RR_0: "<< RecvLowLCM.motorState[FL_0].q <<" FL_1: "<<RecvLowLCM.motorState[FL_1].q<<" FL_2: "<<RecvLowLCM.motorState[FL_2].q<<std::endl;
            if( motiontime >= 0){
                // std::cout<<"Motor Position RR_0: "<< RecvLowLCM.motorState[FL_0].q <<" FL_1: "<<RecvLowLCM.motorState[FL_1].q<<" FL_2: "<<RecvLowLCM.motorState[FL_2].q<<std::endl;
