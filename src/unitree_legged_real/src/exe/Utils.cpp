...
Eigen::Matrix3d Utils::Moore_Penrose_inverse(const Eigen::Matrix3d &mat){
...
double Utils::get_terrain_angle(Eigen::Vector3d surf_coef_1, Eigen::Vector3d surf_coef_2){
